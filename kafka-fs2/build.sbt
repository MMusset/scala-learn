...
lazy val testDependencies = Seq(
  ...
  "com.github.fd4s" %% "fs2-kafka-vulcan-testkit-munit" % Fs2FakfaVersion         % Test
)
...
lazy val dependencies = Seq(
  ...
  "com.github.fd4s"     %% "fs2-kafka"                % Fs2FakfaVersion,
  "com.github.fd4s"     %% "fs2-kafka-vulcan"         % Fs2FakfaVersion
)
